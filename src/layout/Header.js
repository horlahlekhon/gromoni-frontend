            ...
            <div className="main-header-right row">
                ...
                <div className="mobile-sidebar d-block">
                    <div className="media-body text-right switch-sm">
                        <Label className="switch">
                            <Input type="checkbox" onChange={() => dispatch(SwitchToggle(switchToggle))}
                ...
                <form className={`form-inline search-full ${searchTog ? 'open' : ''}`}>
                    <div className="form-group form-control-plaintext">
                        ...
                        />
                        <i onClick={() => dispatch(SearchBarToggle(searchTog))}
                           className="icon-close -search close-search"></i>
                ...
                <div className="d-lg-none mobile-toggle pull-right"><MoreHorizontal
                    onClick={() => dispatch(MobileRightToggle(mobileRightTog))}/></div>
            </div>
        </div>
    )
}
