...
import {validateForm} from '../components/authentication/validator';
...
const CreateBusiness = (props) => {
    ...
    const handleCreateBusiness = async (e) => {
        ...
        if (errors.isErrors) {
            ...
            const response = await props.createBusiness(cookies.accessToken, requestPayload)

            if (response.status) {
                const currentBusiness = response.payload.id
                                ...
                                <Form onSubmit={e => e.preventDefault()} className="create-business-form">
                                    ...
                                    <FormGroup className=" input-group-solid">
                                        ...
                                        <div className="business-location-cont">
                                            ...
                                            <Input className="form-control input-container business-location"
                                                   id="businessLocation"
                                                   type="text"
                                                   placeholder="Business Location"
                                                   value={businessLocation}
                                                   onChange={e => setBusinessLocation({
                                                       place_name: 'Lagos',
                                                       longitude: 123.929,
                                                       latitude: 334.322
                                                   })}/>
                                    ...
                                    <FormGroup>
                                        ...
                                        <Input className="custom-select input-container" type="select"
                                               placeholder="Company type" id="companyType"
                                               value={companyType}
                                    ...
                                    <Row className="btn-cont">
                                        <Col xl={`4`} sm="6" xs="6">
                                            <Button color=" btn-outline-primary"
                                                    className=" create-business-btn cancel-btn"
                                                    onClick={() => props.showMessageAction(false)}>
                                                cancel
                                            </Button>
                                        </Col>
                                        <Col xl={`8`} sm="6" xs="6">
                                    ...
                                    <div className="help-link-cont">
                                        <div>
                                            <a href="http://localhost:3000/help" className="help-link" style={{}}>Need
                                                Help?</a>
                                        </div>
                                    </div>
